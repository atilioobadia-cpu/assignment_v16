// Alpha Associates Custom Theme
// Applies via both CSS inline styles AND frappe.ready() for maximum reliability
...
(function () {
	...
	function applyTheme() {
		...
		var mode = root.getAttribute("data-theme-mode") || root.getAttribute("data-theme") || "light";
	...
	onReady(applyTheme);
	// Also apply on full page load (after all scripts execute)
	if (window.addEventListener) {
		window.addEventListener("load", applyTheme);
	}

	// Watch for theme switches (clicking light/dark/automatic)
